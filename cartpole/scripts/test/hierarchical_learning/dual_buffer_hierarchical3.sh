...
# Train
ID="Dual-Buffer-Hierarchical-3"
MODE='test'
CHECKPOINT="results/models/Dual-Buffer-Hierarchical-3_100"
...
INIT_CONDITION="[0.4172989976094086, 0.050707845883927, 0.2485423578386735, 0.09213432339178134, false]"
