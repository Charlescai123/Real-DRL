...
# Train
ID="Dual-Buffer-Hierarchical-1"
MODE='test'
CHECKPOINT="results/models/Dual-Buffer-Hierarchical-1_50"
...
INIT_CONDITION="[-0.1518298350176420, 0.005707845883927, -0.2068100254495141, 0.05013432339178134, false]"
