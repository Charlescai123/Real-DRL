...
flags.DEFINE_string("experiment_name", "neural-simplex", "experimental name to set.")
...
def main(argv):
    ...
    config.training.algorithm.use_dual_replay_buffer = False      # Solo Buffer
    config.environment.phy_teacher.correct = False       # Do not teach
